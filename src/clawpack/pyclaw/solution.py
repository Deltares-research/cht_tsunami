...
class Solution(object):
    ...
    def read(
        ...
        **kargs,
        ...
        try:
            [t, num_eqn, nstates, num_aux, num_dim, num_ghost, file_format2] = read_t(
        ...
        logging.getLogger("pyclaw.fileio").info(
            "Read in solution for time t=%s" % self.t
        )
        ...
        if file_format[:6] == "binary":
            ...
            try:
                ...
                try:
                    ...
                    raise ImportError(
                        "petsc4py is required for reading petsc format files, but petsc4py could not be imported."
                    )
                raise e
        ...
        if file_format == "forestclaw":
            ...
            try:
                ...
                return importlib.import_module(
                    "clawpack.pyclaw.fileio.%s" % file_format
                ).write
            except:
