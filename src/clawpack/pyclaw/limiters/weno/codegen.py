...
for k in K:
    ...
    f.write(c.uniform_smoothness(function="smoothness_k" + str(k), wrapper=True))
    ...
    f.write(c.uniform_weights(function="weights_left_k" + str(k), wrapper=True))
    f.write(
        c.uniform_reconstruction(function="reconstruct_left_k" + str(k), wrapper=True)
    )
    ...
    f.write(c.uniform_weights(function="weights_right_k" + str(k), wrapper=True))
    f.write(
        c.uniform_reconstruction(function="reconstruct_right_k" + str(k), wrapper=True)
    )
