...
def get_max_boundary_fluxes(
    model_output_dir, max_refinement_depth_to_check=None, frames_to_check=1
):
    ...
    return {
        "max_normal_fluxes": {"W": maxhxl, "E": maxhxu, "N": maxhyu, "S": maxhyl},
        "max_normal_currents": {
            "W": maxcurrxl,
            "E": maxcurrxu,
            "N": maxcurryu,
